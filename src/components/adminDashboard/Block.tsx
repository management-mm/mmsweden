...
const titleWrapperVariants = cva('flex items-center justify-between', {
  ...
  type BlockProps = VariantProps<typeof titleWrapperVariants> & VariantProps<typeof blockWrapperVariants> & VariantProps<typeof titleVariants> & VariantProps<typeof btnVariants> & VariantProps<typeof blockVariants> & {
