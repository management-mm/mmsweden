    ...
    <section className="pb-[48px] md:pb-[84px]">
      <div className="container text-center">
        ...
        <div className="text-center lg:flex lg:justify-between lg:gap-[32px] lg:text-start">
          <picture>
            <source
              srcSet="src/assets/images/home/desktop-home-about-us.webp 1x, src/assets/images/home/desktop-home-about-us@2x.webp 2x, src/assets/images/home/desktop-home-about-us@3x.webp 3x"
              media="(min-width: 1178px)"
              type="image/webp"
            />

            <source
              srcSet="src/assets/images/home/tablet-home-about-us.webp 1x, src/assets/images/home/tablet-home-about-us@2x.webp 2x, src/assets/images/home/tablet-home-about-us@3x.webp 3x"
              media="(min-width: 768px)"
              type="image/webp"
            />
            <source
              srcSet="src/assets/images/home/mobile-home-about-us.webp 1x, src/assets/images/home/mobile-home-about-us@2x.webp 2x, src/assets/images/home/mobile-home-about-us@3x.webp 3x"
              media="(max-width: 767px)"
              type="image/webp"
            />
            <img
              src="src/assets/images/home/mobile-home-about-us.webp"
              alt="Common photo"
              width="100%"
