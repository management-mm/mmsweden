    ...
    <div className="flex w-full items-center gap-2">
      <div className="relative w-full">
        <Field
          ...
          required={required}
          className={cn(
            'border-neutral transition-border duration-primary focus:border-secondary-accent w-full rounded-[32px] border px-[22px] py-[14px] text-[14px] outline-none focus:border',
            className
          )}
        />
