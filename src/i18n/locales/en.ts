...
export const en = {
  ...
  [ContactUs.Info2]:
    'If you have questions regarding <1>payment</1>, please, contact <1>Eva Andersson</1>',
  ...
  [Label.ProductName]: 'Name of the Product',
  [Label.Company]: 'Company Name',
  [Label.AttachPhotos]: 'Attach photos',
  [Label.Country]: 'Choose Your Country',
  [Label.Description]: 'Complete description',
  [Label.Message]: 'Message',
  [Label.Price]: 'Offering price',
  [Label.Subject]: 'Subject',

  [Placeholder.Name]: 'John Doe',
  [Placeholder.Email]: 'john.doe@example.com',
  [Placeholder.Price]: 'Set your offering price',
  [Placeholder.Company]: 'Enter your company name',
  [Placeholder.Description]: 'Describe Your Product',
  [Placeholder.Message]: 'Write your message to us',
  [Placeholder.ProductName]: 'What are you selling?',
