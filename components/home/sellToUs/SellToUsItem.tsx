  ...
  return (
    ...
    >
      <div className="mb-[12px] flex flex-col items-center justify-center md:mb-[22px] md:flex md:gap-[16px] lg:flex-row">
        <SvgIcon
          className={cn('fill-secondary mb-[14px] md:mb-0', iconClassName)}
          iconId={IconId[iconId]}
          size={iconSize}
        />
        <h3 className="text-[18px] leading-tight font-semibold md:text-[24px]">
          {t(title)}
        </h3>
      </div>
      <p className="font-openSans text-secondary-desc text-[16px] leading-normal font-normal lg:text-[18px]">
        {t(desc)}
      </p>
